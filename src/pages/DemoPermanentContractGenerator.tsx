...
import { Download, FileText, ArrowLeft, ArrowRight, Building2, User2, Briefcase, Check, Undo2, Info, Plus } from "lucide-react";
...
const DemoPermanentContractGenerator = () => {
  const { toast } = useToast();
  const navigate = useNavigate();

  const [profile] = useState({
    id: "demo-profile",
    company_name: "Nudoc Demo Holdings (Pty) Ltd",
    registration_number: "2019/123456/07",
    physical_address: "12 Example Street, Sandton, Johannesburg, 2196",
    company_contact: "0115551234",
    company_email: "hello@nudoc.co.za",
  });
  ...
  const [formData, setFormData] = useState<ContractFormState>({
    ...
    employeeIdNumber: "",
    passportNumber: "",
    employeeAddress: "12 Example Street, Sandton, Johannesburg, 2196",
    employeePostalAddress: "PO Box 1234, Sandton, 2146",
    employeeNumber: "EMP-001",
    nationality: "South African",
    gender: "Male",
    race: "African",
    employeeCell: "0821234567",
    alternativeContact: "0825558899",
    employeeEmail: "employee@example.com",
    tradingName: "Nudoc Demo",
    employerContact: "0115551234",
    employerEmail: "hello@nudoc.co.za",
    ...
    retirementAge: "65",
    workplace: "Nudoc Demo Holdings Office",
    interpreter: "no",
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto w-full max-w-6xl space-y-6 px-6 py-10" style={{ scrollbarGutter: "stable" }}>
...
export default DemoPermanentContractGenerator;
