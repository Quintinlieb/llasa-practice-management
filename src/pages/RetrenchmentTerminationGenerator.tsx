...
const RetrenchmentTerminationGenerator = ({
  embedded = false,
  ...
  const generatePDF = (data: RetrenchmentData, download = false) => {
    ...
    if (download) {
      void logGeneratedDocument({
        documentLabel: 'Retrenchment Termination Letter',
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <button
                                ...
                                tabIndex={-1}
                                className="inline-flex items-center text-slate-400 hover:text-slate-600"
                                aria-label="S189 consultation info"
                              >
                                <Info className="h-3.5 w-3.5" />
                              </button>
                            </TooltipTrigger>
                            <TooltipContent side="top" className={fixedTooltipContentClass}>
                              This is the date of the final consultation held with the employees after which the decision to retrench was reached.
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </Label>
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="retrenchmentReasons" className={`${modalFieldLabelClass} inline-flex items-center gap-1`}>
                        Retrenchment reason(s) <span className="text-red-500">*</span>
                      </Label>
                      <button
